...
<t:pagetemplate>
    ...
    <jsp:body>
        ...
        <form action="calculator" method="post">
            ...
            <br>
            <br>
            <label for="carportLengthCM">carport_length: </label>
            <input type="number" id="carportLengthCM" name="carportLengthCM"/>
            <br>
            <br>
            <label for="carportWidthCM">carport_width: </label>
            <input type="number" id="carportWidthCM" name="carportWidthCM"/>
            <br>
            <br>
            <input type="submit"  value="create bom"/>
        </form>
